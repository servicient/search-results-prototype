...
var PriceRangesForm = function (_React$Component) {
  ...
  function PriceRangesForm() {
    _classCallCheck(this, PriceRangesForm);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(PriceRangesForm).apply(this, arguments));
  }
  ...
  _createClass(PriceRangesForm, [{
    ...
    value: function getInput(type) {
      ...
      }, void 0, this.props.labels.currency, ' '), _react2.default.createElement('input', { className: this.props.cssClasses.input, ref: type, type: 'number' }));
    }
  }, {
    key: 'handleSubmit',
    value: function handleSubmit(event) {
      var from = +this.refs.from.value || undefined;
      var to = +this.refs.to.value || undefined;
