...
<html lang="en">
<head>
    <title>Code coverage report for widgets/clear-all/clear-all.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">widgets/clear-all/</a> clear-all.js
    </h1>
    <div class='clearfix'>
...
function clearAll({
    ...
    autoHideContainer = <span class="branch-0 cbranch-no" title="branch not covered" >true</span>
  } = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
  if (<span class="missing-if-branch" title="if path not taken" >I</span>!container) {
    throw <span class="cstat-no" title="statement not covered" >new Error(usage);</span>
  }
&nbsp;
  let containerNode = getContainerNode(container);
  let ClearAll = headerFooterHOC(require('../../components/ClearAll/ClearAll.js'));
  if (<span class="missing-if-branch" title="else path not taken" >E</span>autoHideContainer === true) {
