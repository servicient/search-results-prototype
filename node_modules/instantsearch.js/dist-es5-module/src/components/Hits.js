...
var Hits = function (_React$Component) {
  ...
  _createClass(Hits, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return this.props.results.hits.length === 0 || this.props.results.hits.length !== nextProps.results.hits.length || !(0, _isEqual2.default)(this.props.results.hits, nextProps.results.hits);
    }
  }, {
